...
if (args.length !== 1 || args[0] === '--help') {
  ...
  if (args[0] === '--help') {
    console.log(`${usage}\n\nFrom the clean reviewed revision, verify the manifest, checksums, exact npm/native evidence, all six OCI archives, layer/package efficiency evidence, per-platform Trivy reports, privacy, and vulnerability exceptions without rebuilding, rerunning acceptance, or publishing.`);
    process.exit(0);
  }
